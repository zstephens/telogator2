...
class TG_Reader:
    def __init__(self, input_filename, verbose=True):
        ...
        #
        if fnl[-2:].lower() == 'fq' or fnl[-5:].lower() == 'fq.gz' or fnl[-5:].lower() == 'fastq' or fnl[-8:].lower() == 'fastq.gz':
            self.filetype = 'FASTQ'
        elif fnl[-2:].lower() == 'fa' or fnl[-5:].lower() == 'fa.gz' or fnl[-5:].lower() == 'fasta' or fnl[-8:].lower() == 'fasta.gz':
            self.filetype = 'FASTA'
        else:
